...
export default function PersonaSelector({ activePersona, onSelect, isLoading }: PersonaSelectorProps) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-[#0F172A] rounded-2xl p-6 border border-[#E2E8F0] dark:border-slate-800 shadow-xs flex flex-col gap-5">
  ...
  return (
    <div className="bg-white dark:bg-[#0F172A] rounded-2xl p-6 border border-[#E2E8F0] dark:border-slate-800 shadow-xs transition-shadow duration-300">
      <div className="flex flex-col gap-5">
        ...
        {/* Navigation Tabs (Horizontal scroll pills in a single row) */}
        <div className="overflow-x-auto no-scrollbar scroll-smooth -mx-6 px-6 sm:mx-0 sm:px-0">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isActive 
                      ...
                      : "bg-white dark:bg-[#1E293B] border-[#E2E8F0] dark:border-slate-700 text-[#475569] dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-[#0F172A] dark:hover:text-white cursor-pointer"
                  )}
                >
